...
class Facility(BaseRMPModel):
    ...
    deregistration_date = CopyFromCharField(max_length=10, null=True)
    dereg_effect_date = CopyFromCharField(max_length=10, null=True)
    ...
    num_deaths = CopyFromIntegerField(null=True, blank=True)
    num_injuries = CopyFromIntegerField(null=True, blank=True)
    num_evacuated = CopyFromIntegerField(null=True, blank=True)
    property_damage = CopyFromIntegerField(null=True, blank=True)
    ...
    def get_transform_queryset(self):
        ...
        qs = raw_models.tblFacility.objects.filter(
            ...
            toxic_tot=Sum(Case(When(tbls1facilities__tbls1processes__tbls1processchemicals__ChemicalID__ChemType='T', then=Cast('tbls1facilities__tbls1processes__tbls1processchemicals__Quantity', CopyFromBigIntegerField())), default=Value(0),)),
            flam_tot=Sum(Case(When(tbls1facilities__tbls1processes__tbls1processchemicals__ChemicalID__ChemType='F', then=Cast('tbls1facilities__tbls1processes__tbls1processchemicals__Quantity', CopyFromBigIntegerField())), default=Value(0),)),
            ...
            acc_flam_tot=Cast(Sum(Case(When(tbls1facilities__tbls6accidenthistory__tbls6accidentchemicals__ChemicalID__ChemType='F', then=Cast('tbls1facilities__tbls6accidenthistory__tbls6accidentchemicals__QuantityReleased', CopyFromBigIntegerField())), default=0)) / F('num_accident_divider'), CopyFromBigIntegerField()),
            acc_toxic_tot=Cast(Sum(Case(When(tbls1facilities__tbls6accidenthistory__tbls6accidentchemicals__ChemicalID__ChemType='T', then=Cast('tbls1facilities__tbls6accidenthistory__tbls6accidentchemicals__QuantityReleased', CopyFromBigIntegerField())), default=0)) / F('num_accident_divider'), CopyFromBigIntegerField()),
            acc_quantity_tot=F('acc_flam_tot') + F('acc_toxic_tot'),
            num_deaths=Cast(Sum(F('tbls1facilities__tbls6accidenthistory__DeathsWorkers') + F('tbls1facilities__tbls6accidenthistory__DeathsPublicResponders') + F('tbls1facilities__tbls6accidenthistory__DeathsPublic'), default=Value(0), output_field=CopyFromIntegerField()) / F('num_accident_divider'), CopyFromIntegerField()),
            num_injuries=Cast(Sum(F('tbls1facilities__tbls6accidenthistory__InjuriesPublic') + F('tbls1facilities__tbls6accidenthistory__InjuriesWorkers') + F('tbls1facilities__tbls6accidenthistory__InjuriesPublicResponders'), default=Value(0), output_field=CopyFromIntegerField()) / F('num_accident_divider'), CopyFromIntegerField()),
            num_evacuated=Cast(Sum(F('tbls1facilities__tbls6accidenthistory__Evacuated'), output_field=CopyFromIntegerField()) / F('num_accident_divider'), CopyFromIntegerField()),
            property_damage=Cast(Sum(F('tbls1facilities__tbls6accidenthistory__OnsitePropertyDamage') + F('tbls1facilities__tbls6accidenthistory__OffsitePropertyDamage'), output_field=CopyFromIntegerField()) / F('num_accident_divider'), CopyFromIntegerField()),
        )
        return qs
...
class Registration(BaseRMPModel):
    ...
    num_deaths = CopyFromBigIntegerField(null=True)
    num_injuries = CopyFromBigIntegerField(null=True)
    num_evacuated = CopyFromBigIntegerField(null=True)
    ...
    def get_transform_queryset(self):
        ...
        qs = raw_models.tblS1Facilities.objects.values(
            ...
            toxic_tot=Cast(Sum(Case(When(tbls1processes__tbls1processchemicals__ChemicalID__ChemType='T', then=Cast('tbls1processes__tbls1processchemicals__Quantity', CopyFromBigIntegerField())), default=Value(0), output_field=CopyFromIntegerField())) / F('num_proc_chem_tox'), CopyFromBigIntegerField()),
            flam_tot=Cast(Sum(Case(When(tbls1processes__tbls1processchemicals__ChemicalID__ChemType='F', then=Cast('tbls1processes__tbls1processchemicals__Quantity', CopyFromBigIntegerField())), default=Value(0), output_field=CopyFromIntegerField())) / F('num_proc_chem_flam'), CopyFromBigIntegerField()),
            quantity_tot=F('toxic_tot') + F('flam_tot'),
            acc_flam_tot=Cast(Sum(Case(When(tbls6accidenthistory__tbls6accidentchemicals__ChemicalID__ChemType='F', then=Cast('tbls6accidenthistory__tbls6accidentchemicals__QuantityReleased', CopyFromBigIntegerField())), default=Value(0), output_field=CopyFromIntegerField())) / F('num_accident_divider'), CopyFromBigIntegerField()),
            acc_toxic_tot=Cast(Sum(Case(When(tbls6accidenthistory__tbls6accidentchemicals__ChemicalID__ChemType='T', then=Cast('tbls6accidenthistory__tbls6accidentchemicals__QuantityReleased', CopyFromBigIntegerField())), default=Value(0), output_field=CopyFromIntegerField())) / F('num_accident_divider'), CopyFromBigIntegerField()),
            acc_quantity_tot=F('acc_flam_tot') + F('acc_toxic_tot'),
            num_deaths=Cast(Sum(F('tbls6accidenthistory__DeathsWorkers') + F('tbls6accidenthistory__DeathsPublicResponders') + F('tbls6accidenthistory__DeathsPublic'), default=Value(0), output_field=CopyFromBigIntegerField()) / F('num_accident_divider'), CopyFromIntegerField()),
            num_injuries=Cast(Sum(F('tbls6accidenthistory__InjuriesPublic') + F('tbls6accidenthistory__InjuriesWorkers') + F('tbls6accidenthistory__InjuriesPublicResponders'), default=Value(0), output_field=CopyFromBigIntegerField()) / F('num_accident_divider'), CopyFromIntegerField()),
            num_evacuated=Cast(Sum(F('tbls6accidenthistory__Evacuated'), output_field=CopyFromIntegerField()) / F('num_accident_divider'), CopyFromBigIntegerField()),
            property_damage=Cast(Sum(F('tbls6accidenthistory__OnsitePropertyDamage') + F('tbls6accidenthistory__OffsitePropertyDamage'), output_field=CopyFromIntegerField()) / F('num_accident_divider'), CopyFromBigIntegerField()),
