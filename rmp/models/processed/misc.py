...
class PreventionProgram2(BaseRMPModel): #rmp_prevent_2
    ...
    safety_review_date = CopyFromDateField(
        blank=True
    )
    ...
    hazard_review_date = CopyFromDateField(blank=True)
    change_completion_date = CopyFromDateField(blank=True)
    ...
    op_procedures_review_date = CopyFromDateField(blank=True)
    training_review_date = CopyFromDateField(blank=True)
    ...
    maintenance_review_date = CopyFromDateField(blank=True)
    equipment_inspection_date = CopyFromDateField(blank=True)
    equipment_tested = CopyFromCharField(max_length=200, blank=True)
    compliance_audit_date = CopyFromDateField(blank=True)
    audit_completion_date = CopyFromDateField(blank=True)
    incident_investigation_date = CopyFromDateField(blank=True)
    investigation_change_date = CopyFromDateField(blank=True)
    most_recent_change_date = CopyFromDateField(blank=True)
    ...
    def get_transform_queryset(self):
        ...
        annotations['process_naics'] = F('Process_NAICS_ID')
        annotations['num_prevent_2_chemicals'] = Count('program_2_chemicals')
